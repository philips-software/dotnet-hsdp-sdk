...
{
    public IamToken(string accessToken, DateTime expiresUtc, string tokenType, string scopes, string idToken,
        string signedToken, string issuedTokenType, string? refreshToken = null)
    {
